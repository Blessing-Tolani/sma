    ...
    <div>
        ...
        <div className="w3-container bg-gray-200" >
            <div className="w3-col m6  flex justify-center">
                <img className = " w-2/3  sm:w-1/2 lg:w-2/3 rounded-full" src="/images/test.jpg" alt="" />
            ...
            <div className="w3-col m6 ">
                <div className = " text-center pt-12 bow">
                    ...
                    <a href = "https://twitter.com/Testyb5?s=09"><i class="fab hover:text-gray-900 fa-twitter "></i></a>
               
                <a href = " https://www.facebook.com/testimony.oluwakemi"><i class="fab hover:text-gray-900 fa-facebook-f "></i></a>
                <a href = "https://www.linkedin.com/in/testimony-adebiyi-5162661b3"><i class="fab hover:text-gray-900 fa-linkedin "></i></a>
                    </div>
                </div>
            </div>
