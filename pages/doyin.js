    ...
    <div>
        ...
        <div className="w3-container bg-gray-200" >
            <div className="w3-col m6  flex justify-center">
                <img className = " w-2/3  sm:w-1/2 lg:w-2/3 rounded-full" src="/images/doyin.jpg" alt="" />
            ...
            <div className="w3-col m6 ">
               ...
               She is a content creator that has a flair for business and marketing.
                    ...
                    <div className = "text-lg lg:text-xl pt-2">
                        <a href = "http://www.twitter.com/doyin_olatunji"><i class="fab hover:text-gray-900 fa-twitter "></i></a>
                        <a href = "http://Instagram.com/arinola_w"><i class="fab hover:text-gray-900 fa-instagram "></i></a>
                        <a href = "https://m.facebook.com/ola.sade.313"><i class="fab hover:text-gray-900 fa-facebook-f "></i></a>
                        <a href = "https://www.linkedin.com/mwlite/in/olatunji-doyin-0695741b5"><i class="fab hover:text-gray-900 fa-linkedin "></i></a>
                    </div>
                </div>
            </div>
