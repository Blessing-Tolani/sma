        ...
        <div className="w3-container bg-gray-200" >
            ...
            <div className="w3-col m6 ">
                <div className = " text-center pt-12 bow">
                    ...
                    <a href = "https://www.facebook.com/henyhola.olasogba"><i class="fab hover:text-gray-900 fa-facebook-f "></i></a>
                    <a href = "https://www.linkedin.com/in/eniola-olasogba-7b63751b9"><i class="fab hover:text-gray-900 fa-linkedin "></i></a>
                    </div>
                </div>
            </div>
