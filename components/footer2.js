  ...
  return (
    <>
      ...
      <footer className="w3-black w3-padding-16" id="contact">
        <div className={Style.footer}>
          <div className={Style.foot}>
            ...
            <div className="first">
              ...
              <p className="text-sm">
                Obafemi Awolowo University, <br /> Ile-Ife, Osun State
              </p>
            </div>
          </div>
        ...
        <div className="flex justify-center  mt-6 cursor-pointer">
          <span className=" text-xl">
            <a
              style={{ color: "#a9a9a9" }}
              href="https://twitter.com/TheSMA_Impact?s=09"
            >
              <FaTwitter />
            </a>
          </span>
          <span className=" text-xl  ml-4">
            <a
              style={{ color: "#a9a9a9" }}
              href="https://www.instagram.com/the_sma__/"
            >
              <FaInstagram />
            </a>
          </span>
          <span className=" text-xl  ml-4">
            <a
              style={{ color: "#a9a9a9" }}
              href="https://www.facebook.com/The-S-M-A-Impact-Network-108033684355867/"
            >
              <FaFacebookF />
            </a>
          </span>
      ...
      <div className="text-center bg-black overflow-y-hidden">
        <a href="#top" style={{ color: "#a9a9a9" }} className="text-3xl mb-14">
          <span>
            <IoArrowUpCircleSharp className="inline" />
          </span>
        </a>
